...
var operandos = [];/* parser generated by jison 0.4.13 */
/*
...
case 1:     
                                ...
                                RType = new Instruction(instructionId, $$[$0-5], [$$[$0-3],$$[$0-1]], this.$.instruc, this.$.type,9);
                                stack.addInstruction(RType);
                                instructionCounter++;
break;
case 2:
                                var instructionId = "s" + instructionCounter;
                                RType = new Instruction(instructionId, $$[$0-4], [$$[$0-2],$$[$0]], this.$.instruc, this.$.type,9);
                                stack.addInstruction(RType);
                                instructionCounter++;
break;
case 3:
                                    var instructionId = "s" + instructionCounter;
                                    RType = new Instruction(instructionId, $$[$0-6], [$$[$0-4],$$[$0-2]], this.$.instruc, this.$.type,9);
                                    stack.addInstruction(RType);
                                    instructionCounter++;
break;
case 4:
